...
import { MemberOrderComponent } from 'app/entities/member-order/member-order.component';
...
describe('Component Tests', () => {
    describe('MemberOrder Management Component', () => {
        let comp: MemberOrderComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(MemberOrderComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.memberOrders[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
