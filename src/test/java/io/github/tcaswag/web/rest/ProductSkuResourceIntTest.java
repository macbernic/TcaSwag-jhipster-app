...
import io.github.tcaswag.repository.ProductSkuRepository;
...
public class ProductSkuResourceIntTest {
    ...
    private static final ProductSize UPDATED_SIZE = ProductSize.XSMALL;
    ...
    public void createProductSku() throws Exception {
        ...
        assertThat(testProductSku.getCustomText()).isEqualTo(DEFAULT_CUSTOM_TEXT);
    }
    ...
    public void updateProductSku() throws Exception {
        ...
        assertThat(testProductSku.getCustomText()).isEqualTo(UPDATED_CUSTOM_TEXT);
    }
