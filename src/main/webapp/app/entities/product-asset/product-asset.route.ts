...
export class ProductAssetResolve implements Resolve<IProductAsset> {
    ...
    resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Observable<ProductAsset> {
